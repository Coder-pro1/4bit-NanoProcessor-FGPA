...
signal jp, add_sub, load, add_sub_carry, add_sub_zero: STD_LOGIC;
signal  immediate: STD_LOGIC_VECTOR (3 downto 0);
signal seven_seg_out: STD_LOGIC_VECTOR (6 downto 0);
signal reg_b, muxA_out, muxB_out, add_sub_out: STD_LOGIC_VECTOR  (3 downto 0);   
...
add_sub_zero <= not add_sub_out(0) and not add_sub_out(1) and not add_sub_out(2) and not add_sub_out(3);            
